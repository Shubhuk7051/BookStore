...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            shipping_address_obj=ShippingAddress(customer=customer,
                                                 order=order,
            ...
            payment=client.order.create({ 'amount' : float(total_cart_price) * 100, 'currency' : 'INR', 'payment_capture' : '1'})
    ...
    context = {'form' : form, 'order_items' : order_items, 'total_cart_items' : total_cart_items, 'total_cart_price': total_cart_price, }
